    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">SPARQL Select</h1>
                </div>
                <!--End Page Header -->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info">
                        ...
                        <b>SPARQL</b> The SELECT form of results returns variables and their bindings directly. The syntax SELECT * is an abbreviation that selects all of the variables in a query.
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body" id="queryPlace">
                       		What is the resources and labels?</br></br>
             			...
             			var showResultFrame = function(){
             				document.getElementById("resultFrame").src = "/SparqlPeoject/select";
             			}
             			</script>
