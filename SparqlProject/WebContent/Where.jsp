    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">SPARQL Where</h1>
                </div>
                <!--End Page Header -->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info">
						The query pattern, specifying what to query for in the underlying dataset.</br></br>
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
						...
						What are names and comments  the voice actor subclasses of Actor filter by comments only English?</br>
						PREFIX dbo: &lt;http://dbpedia.org/ontology/&gt;</br>
						PREFIX rdfs: &lt;http://www.w3.org/2000/01/rdf-schema#&gt;</br>
						PREFIX rdf: &lt;http://www.w3.org/1999/02/22-rdf-syntax-ns#&gt;</br></br>
						
						select DISTINCT ?name  ?comment where { </br>
							?Actor rdfs:subClassOf dbo:Artist.</br>
						    ?Actor rdfs:comment ?comment.</br>
						    ?VoiceActor rdfs:subClassOf ?Actor.</br>
							?name rdf:type ?VoiceActor.</br>
						    FILTER (lang(?comment) = "en")</br>
						}    </br> 
						LIMIT 100</br>
             			...
             			var showResultFrame = function(){
             				document.getElementById("resultFrame").src = "/SparqlPeoject/where";
             			}
             			</script>
