    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">SPARQL Order By</h1>
                </div>
                <!--End Page Header -->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
					...
					Find the stadiums that capacity greater than 60000 in world and order by Stadium Capacity
					</br></br>
					<b>Usage:</b></br>
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        ...
                        Find the stadiums that capacity greater than 60000 in world and order by Stadium Capacity</br></br>
						PREFIX dbo:  &lt;http://dbpedia.org/ontology/&gt;</br></br>
						SELECT ?team ?countryOfTeam ?stadiumcapacity </br>
						{ </br>
						...
						order by DESC(?stadiumcapacity)  </br>            
                        </div>
                         <div class="panel-footer">
             			
             			<script>
             			var showResultFrame = function(){
             				document.getElementById("resultFrame").src = "/SparqlPeoject/orderby";
             			}
             			</script>
