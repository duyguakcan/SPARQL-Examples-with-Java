    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">SPARQL Group By</h1>
                </div>
                <!--End Page Header -->
            </div>
...
Find the stadiums that capacity greater than 60000 in world and order by Stadium Capacity and group by Country of Team.</br></br>                        
							PREFIX dbo:  &lt;http://dbpedia.org/ontology/&gt;</br></br>
							SELECT ?team ?countryOfTeam  </br>
							{ </br>
							...
							group by ?team ?countryOfTeam   </br>         
                        </div>
                         <div class="panel-footer">
             			
             			<script>
             			var showResultFrame = function(){
             				document.getElementById("resultFrame").src = "/SparqlPeoject/groupby";
             			}
             			</script>
