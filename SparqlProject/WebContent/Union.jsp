    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">SPARQL Union</h1>
                </div>
                <!--End Page Header -->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info">
						SPARQL contains a UNION pattern; this is formed by placing the keyword UNION between two subsets of statements, each subset delimited by curly brackets
						</br></br>
						<b>Usage:</b></br>
						PREFIX dc10:  &lt;http://purl.org/dc/elements/1.0/&gt;</br>
						PREFIX dc11:  &lt;http://purl.org/dc/elements/1.1/&gt;</br>
						SELECT ?x ?y</br>
						WHERE  { { ?book dc10:title ?x } UNION { ?book dc11:title  ?y } }</br>
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        ...
                        Show people who birth in England, Death in Turkey or Germany and older than 1900</br></br>
							...
							SELECT distinct ?name ?birth ?person ?birthPlace ?deathPlace</br>
							WHERE {      </br>
							{?person dbo:birthPlace dbr:England .   </br>   
							?person dbo:birthDate ?birth . </br>
							?person foaf:name ?name .    </br>  
							?person dbo:birthPlace ?birthPlace .</br>
							?person dbo:deathPlace ?deathPlace .</br>
							?person dbo:deathPlace dbr:Turkey . }</br>
							UNION</br>
							{?person dbo:deathPlace dbr:Germany .</br>
							    ?person dbo:birthDate ?birth . </br>
							   ?person foaf:name ?name .  </br>
							    ?person dbo:birthPlace ?birthPlace . }</br>
							}</br>
							order by DESC(?birth)</br>
             			...
             			var showResultFrame = function(){
             				document.getElementById("resultFrame").src = "/SparqlPeoject/union";
             			}
             			</script>
