    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">SPARQL Construct</h1>
                </div>
                <!--End Page Header -->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
					...
					PREFIX org:    &lt;http://example.com/ns#&gt;</br>
					CONSTRUCT { ?x foaf:name ?name }</br>
					WHERE  { ?x org:employeeName ?name }</br>
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body" id="queryPlace">
                        	What are the meaning of the names?</br></br>
							PREFIX  dbpedia-owl:  &lt;http://dbpedia.org/ontology/&gt;</br>
							PREFIX      dbpprop:  &lt;http://dbpedia.org/property/&gt;</br>
							CONSTRUCT { ?s  dbpprop:meaning  ?meaning }</br>
							WHERE </br>
							  {</br>
							    ?s  a  dbpedia-owl:Name </br>
							     ;  dbpprop:name  ?name </br>
							     ;  dbpprop:meaning  ?meaning </br>
							     .</br>
							  } </br>            
                        </div>
             			...
             			var showResultFrame = function(){
             				document.getElementById("resultFrame").src = "/SparqlPeoject/construct";
             			}
             			</script>
