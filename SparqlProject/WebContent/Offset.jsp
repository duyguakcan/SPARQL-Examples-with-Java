    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">SPARQL Offset</h1>
                </div>
                <!--End Page Header -->
            </div>
...
Sometimes you may not want all possible results. 
The LIMIT clause allows you to limit how many results are returned. 
In the examples used in FILTER and ORDER BY you may only want to the latest 10 results.
                    </div>
                </div>
                <!--end  Welcome -->
            </div>
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body" id="queryPlace">
							...
							SELECT DISTINCT ?name ?child ?birthYear</br>
							WHERE {</br>
							?person dbo:child ?child .</br>
							?child dbo:birthYear ?birthYear .</br>
							?person rdfs:label ?name FILTER (lang(?name) = "en").</br>
							FILTER (?birthYear > "2000-01-01"^^xsd:date)  </br>
							} LIMIT 15 OFFSET 15 </br>          
                        </div>
                         <div class="panel-footer">
             			
             			<script>
             			var showResultFrame = function(){
             				document.getElementById("resultFrame").src = "/SparqlPeoject/offset";
             			}
             			</script>
