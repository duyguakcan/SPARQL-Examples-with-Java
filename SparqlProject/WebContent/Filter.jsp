    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">SPARQL Filter</h1>
                </div>
                <!--End Page Header -->
            </div>
            ...
            <div class="row">
                    ...
                    <div class="panel panel-primary">
                        ...
                        What are names of person whose names are English and their children whose birth date grater than 01.01.2000?</br>
             			...
             			var showResultFrame = function(){
             				document.getElementById("resultFrame").src = "/SparqlPeoject/filter";
             			}
             			</script>
